...
def load_args(default_config=None):
    ...
    # -- utils
    parser.add_argument('--test-manifest', default='data/manifest/LRS3_test_manifest.csv', help='test utt list')
    parser.add_argument('--trial', default='data/trial/lrs3_E.txt', help='lrs3 test set trial')
