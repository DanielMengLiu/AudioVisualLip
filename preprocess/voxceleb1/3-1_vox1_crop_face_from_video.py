...
def load_args(default_config=None):
    ...
    parser.add_argument('--lip-dir', default='/datasets3/voxceleb1/face', help='the directory of saving face ROIs')
    parser.add_argument('--trial', default='data/trial/vox1_O-29.txt', help='list of detected video and its subject ID')
...
if(__name__ == '__main__'):
    files = []
    lines = open(args.trial).read().splitlines()
    for line in lines:
