...
def load_args(default_config=None):
    ...
    # -- utils
    parser.add_argument('--landmark-dir', default='/datasets2/voxceleb1/landmark', help='landmark directory')
    parser.add_argument('--mean-face', default='/data/linchenghan/lip_inter_dataset/voxceleb1/lrs3_mean_face_30000.npy', help='mean face pathname')
...
pattern = os.path.join(args.landmark_dir, 'test', "*/*/*.npz")
