...
def load_args(default_config=None):
    ...
    # -- utils
    parser.add_argument('--video-dir', default='/data/datasets/GRID/video', help='video directory')
    parser.add_argument('--landmark-dir', default='/datasets2/grid/landmark', help='landmark directory')
    parser.add_argument('--lip-dir', default='/data/linchenghan/lip_inter_dataset/grid/lip', help='the directory of saving mouth ROIs')
    parser.add_argument('--manifest', default='/data/liumeng/SyncLip2/data/manifest/grid_test_manifest.csv', help='list of detected video and its subject ID')
    parser.add_argument('--failure-file',
                        default='/data/linchenghan/lip_inter_dataset/grid/lip/grid_lip.failure',
                        help='failure description file')

    # -- mean face utils
    parser.add_argument('--mean-face', default='/data/liumeng/SyncLip2/preprocess/grid/grid_mean_face_2000.npy', help='mean face pathname')
    # -- mouthROIs utils
    parser.add_argument('--crop-width', default=48, type=int, help='the width of mouth ROIs')
    parser.add_argument('--crop-height', default=48, type=int, help='the height of mouth ROIs')
...
def run(files,failure_list):
    for filename in tqdm(files):
        video_path = os.path.join(args.video_dir, filename+'.mpg')
