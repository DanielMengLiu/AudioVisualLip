...
def load_args(default_config=None):
    ...
    parser.add_argument('--landmark-dir', default='/datasets3/voxceleb2/landmark/dev/', help='landmark directory')
    parser.add_argument('--lip-dir', default='/data/linchenghan/lip_inter_dataset/voxceleb2/lip', help='the directory of saving mouth ROIs')
    parser.add_argument('--manifest', default='/data/liumeng/SyncLip3/data/manifest/voxceleb2_dev_manifest.csv', help='list of detected video and its subject ID')
    parser.add_argument('--failure-file',
                        default='/data/linchenghan/lip_inter_dataset/voxceleb2/lip/vox2_lip.failure',
...
def crop_patch(video_pathname, landmarks):
    ...
    try:
        ...
        print('broken video: '+video_pathname)
