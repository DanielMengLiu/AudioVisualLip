...
""" Crop Face ROIs (low resolution 92x92)  from videos for face biometrics"""
import os
import cv2
import argparse
import numpy as np
...
def load_args(default_config=None):
    ...
    # -- utils
    parser.add_argument('--video-dir', default='/datasets3/voxceleb2/video/dev/mp4', help='video directory')
    ...
    # -- mean face utils
    parser.add_argument('--mean-face', default='preprocess/voxceleb2/vox2_mean_face_100k.npy', help='mean face pathname')
    # -- mouthROIs utils
