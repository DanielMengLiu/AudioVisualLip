...
def load_args(default_config=None):
    ...
    # -- utils
    parser.add_argument('--test-manifest', default='/data/liumeng/SyncLip2/data/manifest/grid_test_manifest.csv', help='test utt list')
    parser.add_argument('--trial', default='/data/liumeng/SyncLip2/data/trial/grid_E.trl', help='test set trial')
