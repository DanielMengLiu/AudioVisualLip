...
def load_args(default_config=None):
    ...
    parser.add_argument('--lip-dir', default='/data/linchenghan/lip_inter_dataset/mobilelip/lip', help='the directory of saving mouth ROIs')
    parser.add_argument('--manifest', default='../../preprocess/mobilelip/filelist', help='list of detected video and its subject ID')
    parser.add_argument('--failure-file',
                        default='/data/linchenghan/lip_inter_dataset/mobilelip/lip/mobilelip_lip.failure',
